...
const inputConfigs: InputConfig[] = [
  ...
  },
  {
    ...
    tooltip:
      "Annual salary growth, on top of inflation. Assumed to be a log-normal distributed random variable with the given location and scale. This one is tricky to estimate, because one may for instance change careers. I have no good basis for the default values I've chosen here.",
  },
  {
    id: "rent",
    inputType: "number",
  ...
  },
  {
    ...
    tooltip:
      "Annual rent increase, on top of house price increase. Assumed to be a log-normal distributed random variable with the given location and scale. Note that usually rents rise with house prices, which is why the mean is zero. I haven't found a good source for the standard deviation, so I just guessed something for the default.",
  },
  {
  ...
  },
  {
    ...
    tooltip:
      "Annual inflation. Assumed to be a log-normal distributed random variable with the given location and scale. The default values are the mean and standard deviation of UK annual CPI 1989-2023.",
  },
  {
    ...
    tooltip:
      "Annual appreciation of the stock portfolio, on top of inflation. Assumed to be a log-normal distributed random variable with the given location and scale. The default values are for annual growth over inflation for the S&P 500 index 1989-2023.",
  },
  {
